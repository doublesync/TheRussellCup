...
CONFIG_PLAYER = {
    ...
    "SURCHARGE_INTEREST_INCREMENT": 0.05, # The surcharge interest rate increases by 2% for every 1000 SP spent
    "SURCHARGE_DEFAULT_INTEREST": 0.05, # The default surcharge interest rate
